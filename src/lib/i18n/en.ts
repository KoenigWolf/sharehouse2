...
export const en: Translations = {
  ...
  info: {
    ...
    wifiConfig: "Wi-Fi Settings & Hardware",
    wifiConnectionInfo: "Connection Info",
    wifiStealth: "Hidden SSID",
    wifiSecurity: "Security",
    wifiBand: "Band",
    wifiSource: "Source",
    wifiAccessPoints: "Access Point Locations",
    wifiHardwareDetails: "Hardware Details (for reset)",
    wifiManufactureDate: "Manufacture Date",
    wifiMacAddress: "MAC Address",
    wifiSettingsUrl: "Settings URL",
    wifiAdminUser: "Username",
    wifiAdminPass: "Password",
    wifiInitialSsids: "Initial SSIDs (changed)",
    wifiStealthNote: "Hidden network - enter the network name manually",
    wifiNetworks: "Networks",
    wifiRecommended: "Recommended",
    wifiNoteRouterTitle: "Personal Router Setup",
    wifiNoteRouterContent: "Please avoid setting up your own WiFi router in your room as it may cause interference.",
    wifiNoteRebootTitle: "Automatic Reboot",
    wifiNoteRebootContent: "The main router (PR-500MI) may be unavailable for about 1 minute between 1:00-6:00 AM due to automatic updates.",
  },
  ...
  contact: {
    title: "Contact Us",
    subtitle: "Questions about moving in",
    description: "If you're considering moving in or would like to visit, please feel free to contact us.",
    form: {
      name: "Name",
      ...
      subjectOptions: {
        inquiry: "Questions about moving in",
        tour: "Request a tour",
        other: "Other",
      },
      message: "Message",
      messagePlaceholder: "Please write your questions or requests",
      submit: "Send",
      submitting: "Sending...",
    },
    success: {
  ...
  tour: {
    title: "Book a Tour",
    subtitle: "Experience the Share House",
    description: "We recommend visiting to get a feel for the atmosphere.",
    form: {
      name: "Name",
      namePlaceholder: "John Doe",
      email: "Email",
      ...
      notesPlaceholder: "Any questions or requests",
      submit: "Request Booking",
      submitting: "Booking...",
    },
    success: {
      title: "Booking Requested",
      message: "Thank you for your tour request. A confirmation email has been sent.",
      note: "* We will send a separate email to confirm your booking.",
      backToTop: "Back to Top",
    },
    errors: {
      nameRequired: "Please enter your name",
  ...
  payment: {
    ...
    success: {
      ...
      message: "Thank you for your payment. A confirmation email has been sent.",
    },
    errors: {
