...
export const ja = {
  ...
  mbtiTypes: {
    INTJ: {
      label: "建築家",
      summary: "戦略的思考に長け、複雑な問題を解決することに情熱を注ぐ独立心の強いタイプです。INTJは長期的なビジョンを持ち、それを実現するための計画を緻密に立てることを得意としています。知識への飽くなき探求心があり、常に自己成長を追い求めます。自分自身と周囲に高い基準を求める傾向があり、非効率なプロセスや論理的でない決定には我慢できないこともあります。表面的な会話よりも、深い議論やアイデアの交換を好みます。一見すると冷たく見えることもありますが、信頼できる人には誠実で忠実な一面を見せます。独自の世界観を持ち、多数派に流されることなく、自分が正しいと信じる道を進む強さがあります。",
      traits: "論理的, 独立心, 戦略家, 完璧主義",
    },
    INTP: {
      label: "論理学者",
      summary: "革新的なアイデアと論理的分析を愛する知的好奇心旺盛なタイプです。INTPは抽象的な概念や理論を探求することを好み、物事の本質を理解しようと深く考察します。独自の視点で世界を見つめ、既存の枠組みにとらわれない発想ができます。頭の中には常に複数のアイデアやプロジェクトが渦巻いており、知的な刺激を与えてくれる環境で最も活き活きとします。社交的な場面では控えめに見えることもありますが、興味のあるトピックについては驚くほど饒舌になります。感情よりも論理を重視する傾向があり、客観的な分析を通じて問題にアプローチします。型にはまることを嫌い、自由に思考を巡らせることができる環境を求めます。",
      traits: "分析的, 創造的, 客観的, 知的探求",
    },
    ENTJ: {
      label: "指揮官",
      summary: "目標達成に向けて効率的に人を導くリーダーシップに優れたタイプです。ENTJは明確なビジョンを持ち、それを実現するために周囲を巻き込む力があります。困難な状況でも冷静に判断を下し、チームを成功へと導きます。生まれながらの戦略家であり、長期的な目標を達成するための計画を立て、それを実行に移す能力に長けています。自信に満ちた態度で意見を述べ、時には強引に見えることもありますが、それは物事を前に進めたいという強い意志の表れです。非効率を嫌い、プロセスの改善に常に目を光らせています。チームメンバーの潜在能力を見抜き、適材適所で人を配置することができます。プライベートでは案外世話好きな一面もあります。",
      traits: "決断力, 効率重視, リーダー, 自信家",
    },
    ENTP: {
      label: "討論者",
      summary: "知的な議論を楽しみ、既存の考えに挑戦する革新的なタイプです。ENTPは多角的な視点から物事を捉え、新しい可能性を見出すことが得意です。好奇心旺盛で、様々な分野に興味を持ち、アイデアを次々と生み出します。議論を楽しむことで知られており、時には相手の意見に反論するためだけに論争を仕掛けることもあります。これは悪意からではなく、あらゆる角度から問題を探求したいという知的欲求の表れです。ルーティンや制約を嫌い、自由な発想ができる環境で最も力を発揮します。社交的でウィットに富んだ会話を楽しみ、周囲を笑わせることも得意です。新しいプロジェクトを始めることに情熱を注ぎますが、完成させることよりも次のアイデアに移ることを好む傾向があります。",
      traits: "機知, 挑戦的, 適応力, 発明家",
    },
    INFJ: {
      label: "提唱者",
      summary: "深い洞察力と理想主義を持ち、人々を助けることに喜びを感じるタイプです。INFJは他者の感情や動機を直感的に理解し、意味のあるつながりを築くことを大切にします。静かながらも強い信念を持ち、より良い世界のために貢献しようとする使命感があります。人の心の奥底にある本当の感情を読み取る能力に優れており、カウンセラーのような役割を果たすことがよくあります。表面的な関係よりも、深い信頼関係を築くことを好みます。一人の時間を大切にし、内省を通じてエネルギーを回復させます。創造的な表現力があり、文章や芸術を通じて自分の内面世界を表現することを好みます。MBTIタイプの中で最も希少とされており、独自の視点と深い思考が特徴です。",
      traits: "洞察力, 理想主義, 思いやり, 誠実",
    },
    INFP: {
      label: "仲介者",
      summary: "豊かな内面世界を持ち、自分の価値観に忠実に生きる繊細なタイプです。INFPは創造性と想像力に溢れ、芸術や文学を通じて自己表現することを好みます。他者への深い共感力があり、困っている人を放っておけない優しさを持っています。理想主義的で、世界をより良い場所にしたいという願望を常に抱いています。自分の価値観と相反する状況では、静かながらも強い抵抗を示します。内向的ですが、心を許した相手には情熱的に自分の考えを語ります。日常の美しさや意味を見出す感性があり、詩的な視点で世界を捉えます。完璧主義的な傾向があり、自分の作品やアイデアを世に出すことを躊躇することもあります。夢想家として見られがちですが、信じるもののためには驚くほど粘り強く行動することができます。",
      traits: "創造的, 共感力, 誠実, 理想家",
    },
    ENFJ: {
      label: "主人公",
      summary: "人々の可能性を引き出し、調和のとれた環境を作るカリスマ的なタイプです。ENFJは自然と周囲の人を惹きつけ、グループをまとめる才能があります。他者の成長を心から喜び、そのためにサポートを惜しみません。優れた共感能力を持ち、人の気持ちを察して適切な言葉をかけることができます。人々を鼓舞し、モチベーションを高めることが得意で、天性の教育者やメンターとしての資質を持っています。対立を避ける傾向があり、グループ内の調和を保つために尽力します。他者のニーズに敏感すぎるあまり、自分のニーズを後回しにしてしまうことがあります。理想主義的で、社会をより良くしたいという強い使命感を持っています。コミュニティ活動やボランティアに積極的に参加することが多いです。",
      traits: "カリスマ, 共感力, 利他的, 情熱的",
    },
    ENFP: {
      label: "運動家",
      summary: "情熱的で創造的、人々とのつながりを大切にする自由な精神の持ち主です。ENFPは新しいアイデアや可能性に対してオープンで、周囲にエネルギーと活力をもたらします。人の良いところを見つけ出し、励ますことが得意です。社交的で温かみがあり、初対面の人ともすぐに打ち解けることができます。ルーティンや制約を嫌い、自由と柔軟性を重視します。感情表現が豊かで、喜怒哀楽を素直に表現します。好奇心旺盛で、様々な興味を持っていますが、一つのことに集中し続けることは苦手な傾向があります。理想主義的で、世界の可能性を信じており、ポジティブな変化を起こそうとします。深い会話を楽しみ、人生の意味や目的について語り合うことを好みます。創造的なプロジェクトに情熱を注ぎ、周囲を巻き込んで実現しようとします。",
      traits: "情熱的, 創造的, 社交的, 楽観的",
    },
    ISTJ: {
      label: "管理者",
      summary: "責任感が強く、伝統と秩序を重んじる信頼性の高いタイプです。ISTJは約束は必ず守り、任された仕事は最後までやり遂げます。事実とデータに基づいて判断し、着実に物事を進めていく堅実さがあります。規則やルールを尊重し、社会の秩序を維持することを大切にします。計画を立てて行動することを好み、予期せぬ変化には戸惑うことがあります。感情よりも論理を重視し、客観的な事実に基づいて判断します。言葉少なく見えることもありますが、行動で誠実さを示します。長年の経験と知識を蓄積し、それを実践に活かすことが得意です。家族や親しい人々に対しては深い忠誠心を持ち、安定した環境を提供しようと努めます。静かながらも芯の強さを持ち、困難な状況でも責任を果たします。",
      traits: "責任感, 実直, 計画的, 信頼性",
    },
    ISFJ: {
      label: "擁護者",
      summary: "思いやり深く、周囲の人々を献身的にサポートする温かいタイプです。ISFJは細やかな気配りができ、人のニーズを察する能力に優れています。控えめながらも、大切な人のためなら労を惜しまず尽くします。伝統や習慣を大切にし、安定した環境を好みます。過去の経験を大切にし、それを現在の判断に活かします。感謝されることを求めずに奉仕しますが、認められると大きな喜びを感じます。対立を避ける傾向があり、周囲との調和を保つために努力します。責任感が強く、一度引き受けた仕事は最後まで丁寧にやり遂げます。家庭的な雰囲気を作ることが得意で、周囲の人を安心させる存在です。変化よりも安定を好みますが、大切な人のためなら自分を犠牲にすることも厭いません。",
      traits: "献身的, 思いやり, 謙虚, 忠実",
    },
    ESTJ: {
      label: "幹部",
      summary: "組織力に優れ、ルールと効率を重視する実務的なタイプです。ESTJは明確な目標に向かってチームを率い、秩序ある環境を作り出します。責任感が強く、自分にも他者にも規律を求めますが、その分結果を出すことができます。伝統と秩序を尊重し、確立されたシステムの中で力を発揮します。直接的なコミュニケーションを好み、曖昧な表現を嫌います。リーダーシップを発揮することを自然と求められ、グループをまとめることが得意です。実用的な解決策を見つけ、それを効率的に実行することに長けています。誠実で正直であり、約束は必ず守ります。時に頑固に見えることもありますが、それは自分の信念に忠実であることの表れです。コミュニティへの貢献を大切にし、社会的な責任を果たそうとします。",
      traits: "組織力, 実務的, 決断力, 責任感",
    },
    ESFJ: {
      label: "領事官",
      summary: "社交的で協調性があり、周囲の幸福を第一に考える世話好きなタイプです。ESFJは人との調和を大切にし、グループの中で潤滑油のような役割を果たします。実用的なサポートを通じて愛情を表現し、コミュニティを大切にします。他者のニーズに敏感で、困っている人がいれば進んで手を差し伸べます。伝統や習慣を重視し、家族や友人との絆を大切にします。イベントやお祝い事を企画することが得意で、人々を集めて楽しい時間を作り出します。認められることを嬉しく感じ、感謝の言葉に大きな喜びを感じます。対立を避け、周囲との平和を保つために努力します。責任感があり、約束したことは必ず守ります。温かい家庭的な雰囲気を作ることが得意で、周囲の人に安心感を与える存在です。",
      traits: "社交的, 協調性, 親切, 忠実",
    },
    ISTP: {
      label: "巨匠",
      summary: "冷静な観察眼と優れた問題解決能力を持つ実践的なタイプです。ISTPは手を動かして物事を理解することを好み、機械やシステムの仕組みに興味を持ちます。危機的状況でも落ち着いて対処でき、効率的な解決策を見つけ出します。論理的思考に優れ、感情に流されることなく客観的に状況を分析します。自由と独立を重視し、束縛されることを嫌います。寡黙に見えることもありますが、それは言葉よりも行動で示すタイプだからです。実践的なスキルを持ち、道具を使いこなすことが得意です。予測不可能な状況でも冷静さを保ち、臨機応変に対応できます。リスクを恐れず、スリルのある経験を楽しむ一面もあります。信頼関係を築いた相手には、意外なほどユーモアのある一面を見せることがあります。",
      traits: "冷静, 実践的, 適応力, 論理的",
    },
    ISFP: {
      label: "冒険家",
      summary: "芸術的センスと柔軟性を持ち、今この瞬間を大切にするタイプです。ISFPは五感を通じて世界を体験することを好み、美しいものに心を動かされます。自分のペースを大切にし、押し付けがましさのない穏やかさで周囲を和ませます。自分の価値観に忠実に生き、他者の価値観も尊重します。言葉よりも行動で愛情を表現し、さりげない優しさで周囲を支えます。自然や芸術との触れ合いを楽しみ、そこからインスピレーションを得ます。対立を避ける傾向があり、調和のとれた環境を好みます。計画を立てることよりも、その場の流れに身を任せることを好みます。感受性が豊かで、他者の感情を敏感に察知します。自由を愛し、型にはまることを嫌いますが、大切な人や信念のためには強い意志を見せることもあります。",
      traits: "芸術的, 柔軟, 穏やか, 感受性",
    },
    ESTP: {
      label: "起業家",
      summary: "行動力があり、スリルと新しい経験を求める活動的なタイプです。ESTPは今この瞬間を楽しみ、チャンスがあれば即座に行動に移します。社交的で影響力があり、その場の空気を読んで柔軟に対応することができます。実践的な問題解決能力に優れ、理論よりも実際に試してみることを好みます。リスクを恐れず、スリリングな挑戦を楽しみます。直接的なコミュニケーションを好み、遠回しな表現を嫌います。観察力が鋭く、周囲の状況を素早く把握します。エネルギッシュで、退屈を嫌い、常に刺激を求めています。交渉力があり、人を説得することが得意です。計画を立てるよりも、状況に応じて臨機応変に行動することを好みます。競争心があり、チャレンジングな状況で力を発揮します。",
      traits: "行動力, 大胆, 現実的, 社交的",
    },
    ESFP: {
      label: "エンターテイナー",
      summary: "社交的で楽観的、周囲を楽しませることが得意なエンターテイナーです。ESFPは人生を楽しむことに長け、その明るさで周りの人々を元気づけます。自発的で柔軟性があり、新しい人や経験との出会いを心から楽しみます。その場の雰囲気を盛り上げる才能があり、パーティーやイベントの中心になることが多いです。五感を通じて世界を楽しみ、美味しい食事や音楽、自然を満喫します。計画を立てることよりも、その場のノリを大切にします。感情表現が豊かで、喜怒哀楽を素直に表現します。人を助けることが好きで、困っている人がいれば進んでサポートします。実用的な問題解決が得意で、理論よりも実践を重視します。ネガティブな状況でもポジティブな面を見つけ出し、周囲を励ますことができます。",
