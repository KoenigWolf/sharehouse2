...
export const ja = {
  ...
  info: {
    ...
    wifiConfig: "Wi-Fi 設定・機器情報",
    wifiConnectionInfo: "接続情報",
    wifiStealth: "ステルス設定",
    wifiSecurity: "セキュリティ",
    wifiBand: "周波数帯",
    wifiSource: "設置元",
    wifiAccessPoints: "アクセスポイント設置場所",
    wifiHardwareDetails: "機器詳細（リセット時参照用）",
    wifiManufactureDate: "製造年月",
    wifiMacAddress: "MACアドレス",
    wifiSettingsUrl: "設定画面",
    wifiAdminUser: "ユーザー名",
    wifiAdminPass: "パスワード",
    wifiInitialSsids: "初期SSID（変更済み）",
    wifiStealthNote: "ステルスモードのため、手動でネットワーク名を入力してください",
    wifiNetworks: "ネットワーク一覧",
    wifiRecommended: "推奨",
    wifiNoteRouterTitle: "個別ルーターの設置",
    wifiNoteRouterContent: "自室に別途Wi-Fiルーターを設置すると電波が混線するため、極力避けてください。",
    wifiNoteRebootTitle: "自動再起動",
    wifiNoteRebootContent: "親機1（PR-500MI）はバージョンアップのため、午前1時〜午前6時の間に約1分間、自動再起動により通信が利用できない場合があります。",
  },
  ...
  contact: {
    title: "お問い合わせ",
    subtitle: "入居に関するご質問やご相談",
    description: "入居をご検討中の方、見学をご希望の方はお気軽にお問い合わせください。",
    form: {
      name: "お名前",
      namePlaceholder: "山田 太郎",
      email: "メールアドレス",
      ...
      message: "お問い合わせ内容",
      messagePlaceholder: "ご質問やご希望をお書きください",
      submit: "送信する",
      submitting: "送信中...",
    },
    success: {
  ...
  tour: {
    title: "見学予約",
    subtitle: "シェアハウスを体験",
    description: "実際の雰囲気を感じていただくために、見学をおすすめしています。",
    form: {
      name: "お名前",
      namePlaceholder: "山田 太郎",
      email: "メールアドレス",
      ...
      notes: "備考（任意）",
      notesPlaceholder: "ご質問やご要望があればお書きください",
      submit: "予約を申し込む",
      submitting: "予約中...",
    },
    success: {
      title: "予約申込み完了",
      message: "見学予約のお申込みありがとうございます。確認メールをお送りしました。",
      note: "※ 予約確定のご連絡は別途メールにてお送りいたします。",
      backToTop: "トップに戻る",
    },
    errors: {
      nameRequired: "お名前を入力してください",
  ...
  payment: {
    ...
    success: {
      title: "お支払い完了",
      message: "お支払いありがとうございます。確認メールをお送りしました。",
    },
    errors: {
