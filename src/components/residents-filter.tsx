  ...
  return (
    <div className="flex items-center gap-1.5 sm:gap-2" role="search">
      ...
      <Input
        ...
        className="h-7 sm:h-8 w-24 sm:w-40 text-xs sm:text-sm border-[#e4e4e7] rounded-md focus:border-[#18181b] focus:ring-0"
      />

      <div
        className="flex border border-[#e4e4e7] rounded-md divide-x divide-[#e4e4e7] overflow-hidden"
        role="group"
          ...
          return (
            <Button
              ...
              className={`h-auto text-[10px] sm:text-[11px] px-1.5 sm:px-2 py-1 ${
                !isSelected ? "bg-white text-[#71717a] hover:bg-[#f4f4f5]" : ""
              }`}
            >
              {t(option.labelKey)}
            </Button>
