            ...
            <div className="mt-10 pt-10 border-t border-slate-100/80">
              ...
              <div className="flex flex-wrap gap-2.5">
                {profile.interests.map((interest, index) => (
                  <span
                    key={index}
                    className="text-[13px] px-4 py-2 rounded-xl bg-slate-50 text-slate-600 font-medium border border-slate-100/50 hover:bg-white hover:shadow-sm hover:border-emerald-100 transition-all cursor-default"
                  >
                    {interest}
                  </span>
                ))}
          ...
          {(isOwnProfile || roomPhotos.length > 0) && (
            <div className="mt-10 pt-10 border-t border-slate-100/80">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link
                  href="/room-photos"
                  className="text-[10px] text-emerald-600 font-bold tracking-wider uppercase hover:text-emerald-700 transition-colors bg-emerald-50 px-3 py-1.5 rounded-full"
                >
