...
const FLOOR_COLORS: Record<Floor, { bg: string; text: string; border: string; accent: string }> = {
  ...
  "5F": { bg: "bg-indigo-50", text: "text-indigo-900", border: "border-indigo-100", accent: "bg-indigo-500" },
};
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? `${floorColors.bg} ${floorColors.text} shadow-lg shadow-indigo-100 ring-2 ring-indigo-500/20`
          ...
          >
            {rooms.map((roomNumber) => {
              ...
              return (
                ...
                >
                  {isCurrentUser && (
                    <span className="absolute -top-2 -right-2 bg-indigo-600 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full z-10 shadow-sm">
                      {t("common.you")}
                    </span>
                  )}
    ...
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {isCurrentUser && (
              <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-indigo-600 text-white shadow-sm shrink-0`}>
                {t("common.you")}
              </span>
            )}
          </div>
      ...
      {!isMock && (
        <Link
          ...
          className="block w-full text-center text-sm font-bold py-3.5 bg-indigo-600 text-white rounded-xl shadow-lg shadow-indigo-100 hover:bg-indigo-700 hover:shadow-indigo-200 transition-all active:scale-[0.98]"
        >
