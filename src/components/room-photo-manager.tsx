      ...
      {!compact && (
        <div className="px-6 py-4 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
          <p className="text-[10px] text-slate-400 font-bold tracking-widest uppercase flex items-center gap-2">
            <svg className="w-3.5 h-3.5 text-emerald-600
" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
            </svg>
            {t("roomPhotos.roomPhotosSection")}
          </p>
          <span className="text-[10px] text-emerald-500 font-bold tracking-wider bg-emerald-50 px-2.5 py-1 rounded-full">
        ...
        <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 gap-4">
          {currentPhotos.map((photo) => (
            <m.div
              ...
              className="relative aspect-square bg-slate-50 rounded-2xl overflow-hidden ring-1 ring-slate-100 group shadow-sm"
            >
              <Image
                src={photo.photo_url}
          ...
          {canUpload && (
            <m.button
              ...
              className="aspect-square rounded-2xl border-2 border-dashed border-slate-100 bg-slate-50/50 hover:bg-white hover:border-emerald-200 hover:shadow-md transition-all duration-300 flex flex-col items-center justify-center gap-2 group"
            >
              {isUploading ? (
 ...
 transition-colors">
                  ...
                  <span className="text-[10px] text-slate-400 font-bold tracking-wider uppercase group-hover:text-emerald-500 transition-colors">
                    {t("roomPhotos.upload")}
                  </span>
                </>
              )}
