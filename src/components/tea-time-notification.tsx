        ...
        <div className="premium-surface p-4 sm:p-6 rounded-2xl relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="relative flex items-center gap-6">
            ...
            <div className="flex-1 min-w-0">
              <span className="text-[10px] text-brand-600 font-bold uppercase tracking-wider bg-brand-50 px-2 py-0.5 rounded-full">
            ...
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 group-hover:text-brand-600 group-hover:bg-brand-50 transition-all shrink-0">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
